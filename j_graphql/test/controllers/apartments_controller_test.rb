...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { description: @apartment.description, resort_id: @apartment.resort_id, room_type: @apartment.room_type } }, as: :json
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { description: @apartment.description, resort_id: @apartment.resort_id, room_type: @apartment.room_type } }, as: :json
    assert_response :success
  end
